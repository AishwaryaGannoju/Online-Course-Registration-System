...
<body>
  ...
  <h2 class="welcome">Welcome,<span id="spanName"><%=request.getParameter("name")%></span></h2>
   <ul class="options">
    <a href="<%=request.getContextPath()%>/enroll"><li>&#x2799;  Enroll for a course</li></a>
    <a href="viewMyCourses.jsp"><li id="lastitem">&#x2799;  View the courses Enrolled</li></a>
   </ul>
    </div>
