...
<body>
    ...
    <div class="form1">
       ...
       <h3>Courses registered by a Student</h3>
			Email id:<input type="email" name="email" value="<c:out value='${course.email}' />" placeholder="enter student email id" required/><br><br>		
